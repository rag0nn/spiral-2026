...
class Registery:
    ...
    os_afo = DataPack(
        ...
        xml_labels_path=BASE_DIR / "OPENSRC/AFO/labels",
        translations_path=None
    )
    
    os_lacmus = DataPack(
        frames_path=BASE_DIR / "OPENSRC/lacmus/frames",
        xml_labels_path=BASE_DIR / "OPENSRC/lacmus/labels",
        translations_path=None
    )
    
    os_semantic_drone = DataPack(
        frames_path=BASE_DIR / "OPENSRC/semantic_drone/frames",
        xml_labels_path=BASE_DIR / "OPENSRC/semantic_drone/labels",
        translations_path=None
    )
    
    os_SOAP = DataPack(
        frames_path=BASE_DIR / "OPENSRC/SOAP/frames",
        xml_labels_path=BASE_DIR / "OPENSRC/SOAP/labels",
        translations_path=None
    )
    ...
    ot24_6 = DataPack(
        ...
        xml_labels_path=BASE_DIR / "2024/TP24_O6_0-390/labels",
        translations_path=None
    )
    ...
    ot22_2_1 = DataPack(
        ...
        xml_labels_path=BASE_DIR / "2022/T22_O2_1/labels",
        translations_path=None
    )
    
    ot22_2_2 = DataPack(
        frames_path=BASE_DIR / "2022/T22_O2_2/frames",
        xml_labels_path=BASE_DIR / "2022/T22_O2_2/labels",
        translations_path=None
    )
    
    ot22_2_3 = DataPack(
        frames_path=BASE_DIR / "2022/T22_O2_3/frames",
        xml_labels_path=BASE_DIR / "2022/T22_O2_3/labels",
        translations_path=None
    )
    
    ot22_2_4 = DataPack(
        frames_path=BASE_DIR / "2022/T22_02_4/frames",
        xml_labels_path=BASE_DIR / "2022/TP22_02_4/labels",
        translations_path=None
    )
    
    ot22_2_5 = DataPack(
        frames_path=BASE_DIR / "2022/T22_O2_5/frames",
        xml_labels_path=BASE_DIR / "2022/TP22_O2_5/labels",
        translations_path=None
    )
    
    ot22_1_1 = DataPack(
        frames_path=BASE_DIR / "2022/TP22_O1_1_1/frames",
        xml_labels_path=BASE_DIR / "2022/TP22_O1_1_1/labels",
        translations_path=None
    )
    ...
    ot22_1_2 = DataPack(
        ...
        xml_labels_path=BASE_DIR / "2022/TP22_O1_2/labels",
        translations_path=None
    )
    
    ot22_3_1 = DataPack(
        frames_path=BASE_DIR / "2022/TP22_O3_1/frames",
        xml_labels_path=BASE_DIR / "2022/TP22_O3_1/labels",
        translations_path=None
    )
    
    ot22_3_2 = DataPack(
        frames_path=BASE_DIR / "2022/TP22_O3_2/frames",
        xml_labels_path=BASE_DIR / "2022/TP22_O3_2/labels",
        translations_path=None
    )
    
    ot22_3_3 = DataPack(
        frames_path=BASE_DIR / "2022/TP22_O3_3/frames",
        xml_labels_path=BASE_DIR / "2022/TP22_O3_3/labels",
        translations_path=None
    )
    
    ot22_4_1_1 = DataPack(
        frames_path=BASE_DIR / "2022/TP22_O4_1_1/frames",
        xml_labels_path=BASE_DIR / "2022/TP22_O4_1_1/labels",
        translations_path=None
    )

    ot22_4_1_2 = DataPack(
        frames_path=BASE_DIR / "2022/TP22_O4_1_2_AREAFUL/frames",
        xml_labels_path=BASE_DIR / "2022/TP22_O4_1_2_AREAFUL/labels",
        translations_path=None
    )
    
    ot22_4_2 = DataPack(
        frames_path=BASE_DIR / "2022/TP22_O4_2/frames",
        xml_labels_path=BASE_DIR / "2022/TP22_O4_2/labels",
        translations_path=None
    )
    # == Teknofest 2021 ==========================
    ot21_1 = DataPack(
        frames_path=BASE_DIR / "2021/T21_O1/frames",
        xml_labels_path=BASE_DIR / "2021/T21_O1/labels",
        translations_path=None
    )
    
    ot21_p = DataPack(
        frames_path=BASE_DIR / "2021/TP21_ORNEK_O1/frames",
        xml_labels_path=BASE_DIR / "2021/TP21_ORNEK_O1/labels",
        translations_path=None
    )
